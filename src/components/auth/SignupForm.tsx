    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm dark:text-gray-400 light:text-gray-600">
          Join us and start your search adventure
        </p>
      </div>
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 dark:text-gray-400 light:text-gray-500" />
                    <Input 
